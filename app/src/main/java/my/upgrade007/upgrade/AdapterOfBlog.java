...
import my.upgrade007.upgrade.BlogModel.Item;
...
public class AdapterOfBlog extends RecyclerView.Adapter<AdapterOfBlog.BlogViewHolder> {
    ...
    ManuString manuString = new ManuString();
    ...
    public void onBindViewHolder(@NonNull final BlogViewHolder holder, final int position) {
        ...
        String mainString = manuString.getPerfectString(items.get(position).getPublished());
        holder.blogdatepublishedAt.setText(mainString);
