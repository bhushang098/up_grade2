...
public class ListSyllabus extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    public String[] brNames = {"General Aptitude(GA)", "Aerospace Engineering (AE)", "Agricultural Engineering(AG)", "Architecture and Planning (AR)", "Biotechnology (BT)"
            ...
            "Production and Industrial Engineering (PI)", "Textile Engineering and Fiber Science (TF)", "Engineering Mathematics(XE-A)", "Fluid Mechanics(XE-B)", "Materials Science (XE-c)",
            ...
            "Chemistry(XL-P)", "Biochemistry (XL-Q)", "Botany (XL-R)", "Microbiology (XL-s)", "Zoology (XL-T)", "Food Technology(XL-U)", "Statistics (ST)","BioMedical Engineering"};
    ...
    public int[] brImage = {R.drawable.contract, R.drawable.plane, R.drawable.agriculture, R.drawable.architecture, R.drawable.biotechnology,
            ...
            R.drawable.p_chemistry, R.drawable.biochemistry, R.drawable.botany, R.drawable.microbiology, R.drawable.zoology, R.drawable.foodtecg2, R.drawable.instrumentalengg,
            R.drawable.biotechnology};
    ...
    String[] url = {"https://firebasestorage.googleapis.com/v0/b/fir-1-b4412.appspot.com/o/syllabus%2FGeneral-Aptitude_compressed.pdf?alt=media&token=2dc1ef23-7966-45f9-b81b-f65859438ede"
            ...
            "https://firebasestorage.googleapis.com/v0/b/fir-1-b4412.appspot.com/o/syllabus%2FXE_A-Engineering-Mathematics_compressed.pdf?alt=media&token=3aa50be5-d55d-49b1-927a-df3f219a2cfa",
            ...
            "https://firebasestorage.googleapis.com/v0/b/fir-1-b4412.appspot.com/o/syllabus%2FStatitics%20.pdf?alt=media&token=1569b5c5-87eb-45d1-a49d-94ae148ae188",
            "https://firebasestorage.googleapis.com/v0/b/fir-1-b4412.appspot.com/o/syllabus%2F1563529799BM.pdf?alt=media&token=90bd90c4-7415-41e3-b882-cf484870c367"};
