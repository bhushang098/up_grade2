...
import my.upgrade007.upgrade.api.ApiClient;
import my.upgrade007.upgrade.api.ApiInterface;
import my.upgrade007.upgrade.models.Article;
    ...
    public void loadJSON(final String keyWord){
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onFailure(Call<News> call, Throwable t) {
                refreshLayout.setRefreshing(false);
                showError("No Results","Check Internet Connection ",progressBar);
            }
        });
    }
